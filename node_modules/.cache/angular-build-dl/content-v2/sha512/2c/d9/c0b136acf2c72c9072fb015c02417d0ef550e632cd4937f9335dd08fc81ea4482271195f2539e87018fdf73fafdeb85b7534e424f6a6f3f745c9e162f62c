(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~gestion-actividades-actividades-module~gestion-convenios-convenios-module~gestion-enlaces-en~5eaaa385"], {
    /***/
    "4NA8":
    /*!****************************************************!*\
    ...
    /***/
    function NA8(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var NgbDateCustomParserFormatter = /*#__PURE__*/function (_ng_bootstrap_ng_boot) {
        ...
        _createClass(NgbDateCustomParserFormatter, [{
          ...
          value: function format(date) {
            return date ? "".concat(isNumber(date.day) ? padNumber(date.day) : "", "/").concat(isNumber(date.month) ? padNumber(date.month) : "", "/").concat(date.year) : "";
          }
        }]);
    ...
    function FKr1(module, __webpack_exports__, __webpack_require__) {
      ...
      var VERSION$1 = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["Version"]('11.2.10');
      /** @docs-private */
    ...
    function bSwM(module, __webpack_exports__, __webpack_require__) {
      ...
      var MatCheckbox = /*#__PURE__*/function (_MatCheckboxMixinBase2) {
        ...
        function MatCheckbox(elementRef, _changeDetectorRef, _focusMonitor, _ngZone, tabIndex, _animationMode, _options) {
          ...
          _this18 = _super12.call(this, elementRef);
          ...
          _this18.ariaLabelledby = null;
          _this18._uniqueId = "mat-checkbox-".concat(++nextUniqueId);
          /** A unique id for the checkbox input. If none is supplied, it will be auto-generated. */

          _this18.id = _this18._uniqueId;
          /** Whether the label should appear after or before the checkbox. Defaults to 'after' */

          _this18.labelPosition = 'after';
          /** Name value will be applied to the input element if present */

          _this18.name = null;
          /** Event emitted when the checkbox's `checked` value changes. */

          _this18.change = new _angular_core__WEBPACK_IMPORTED_MODULE_2__["EventEmitter"]();
          /** Event emitted when the checkbox's `indeterminate` value changes. */

          _this18.indeterminateChange = new _angular_core__WEBPACK_IMPORTED_MODULE_2__["EventEmitter"]();
          /**
          ...
          _this18._currentAnimationClass = '';
          _this18._currentCheckState = 0
          /* Init */
          ;

          _this18._controlValueAccessorChangeFn = function () {};

          _this18._checked = false;
          _this18._disabled = false;
          _this18._indeterminate = false;
          _this18._options = _this18._options || defaults;
          _this18.color = _this18.defaultColor = _this18._options.color || defaults.color;
          ...
          value: function _onInputClick(event) {
            ...
            if (!this.disabled && clickAction !== 'noop') {
              ...
              if (this.indeterminate && clickAction !== 'check') {
                Promise.resolve().then(function () {
                  _this20._indeterminate = false;

                  _this20.indeterminateChange.emit(_this20._indeterminate);
                });
              }
    ...
    function suls(module, __webpack_exports__, __webpack_require__) {
      ...
      (function (module) {
        ...
        __webpack_exports__["default"] = KTLayoutExamples; //# sourceMappingURL=examples.js.map
    ...
    function u47x(module, __webpack_exports__, __webpack_require__) {
        ...
        function ListKeyManager(_items) {
          ...
          if (_items instanceof _angular_core__WEBPACK_IMPORTED_MODULE_1__["QueryList"]) {
            _items.changes.subscribe(function (newItems) {
              if (_this21._activeItem) {
                var itemArray = newItems.toArray();
                var newIndex = itemArray.indexOf(_this21._activeItem);

                if (newIndex > -1 && newIndex !== _this21._activeItemIndex) {
                  _this21._activeItemIndex = newIndex;
                }
              }
            });
          }
        ...
        _createClass(ListKeyManager, [{
          ...
          value: function withTypeAhead() {
            ...
            this._typeaheadSubscription = this._letterKeyStream.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (letter) {
              return _this22._pressedLetters.push(letter);
              ...
              return _this22._pressedLetters.length > 0;
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function () {
              return _this22._pressedLetters.join('');
            })).subscribe(function (inputString) {
              var items = _this22._getItemsArray(); // Start at 1 because we want to start searching at the item immediately
              // following the current active item.


              for (var i = 1; i < items.length + 1; i++) {
                var index = (_this22._activeItemIndex + i) % items.length;
                var item = items[index];

                if (!_this22._skipPredicateFn(item) && item.getLabel().toUpperCase().trim().indexOf(inputString) === 0) {
                  _this22.setActiveItem(index);

                  break;
                }
              }

              _this22._pressedLetters = [];
            });
            return this;
          }
          /**
          ...
          value: function onKeydown(event) {
            ...
            var isModifierAllowed = modifiers.every(function (modifier) {
              return !event[modifier] || _this23._allowedModifierKeys.indexOf(modifier) > -1;
            });
      ...
      var ActiveDescendantKeyManager = /*#__PURE__*/function (_ListKeyManager) {
        ...
        var _super14 = _createSuper(ActiveDescendantKeyManager);
      ...
      var FocusKeyManager = /*#__PURE__*/function (_ListKeyManager2) {
        ...
        var _super15 = _createSuper(FocusKeyManager);
        ...
        function FocusKeyManager() {
          ...
          _this24 = _super15.apply(this, arguments);
          _this24._origin = 'program';
          return _this24;
        }
        /**
      ...
      var FocusTrap = /*#__PURE__*/function () {
        function FocusTrap(_element, _checker, _ngZone, _document) {
          ...
          this.startAnchorListener = function () {
            return _this25.focusLastTabbableElement();
          };

          this.endAnchorListener = function () {
            return _this25.focusFirstTabbableElement();
          };
        ...
        _createClass(FocusTrap, [{
          ...
          value: function attachAnchors() {
            ...
            this._ngZone.runOutsideAngular(function () {
              if (!_this26._startAnchor) {
                _this26._startAnchor = _this26._createAnchor();

                _this26._startAnchor.addEventListener('focus', _this26.startAnchorListener);
              }

              if (!_this26._endAnchor) {
                _this26._endAnchor = _this26._createAnchor();

                _this26._endAnchor.addEventListener('focus', _this26.endAnchorListener);
              }
            });
          ...
          value: function focusInitialElementWhenReady() {
            ...
            return new Promise(function (resolve) {
              _this27._executeOnStable(function () {
                return resolve(_this27.focusInitialElement());
              });
            });
          }
          /**
          ...
          value: function focusFirstTabbableElementWhenReady() {
            ...
            return new Promise(function (resolve) {
              _this28._executeOnStable(function () {
                return resolve(_this28.focusFirstTabbableElement());
              });
            });
          }
          /**
          ...
          value: function focusLastTabbableElementWhenReady() {
            ...
            return new Promise(function (resolve) {
              _this29._executeOnStable(function () {
                return resolve(_this29.focusLastTabbableElement());
              });
            });
          }
          /**
      ...
      var ConfigurableFocusTrap = /*#__PURE__*/function (_FocusTrap) {
        ...
        var _super16 = _createSuper(ConfigurableFocusTrap);
        ...
        function ConfigurableFocusTrap(_element, _checker, _ngZone, _document, _focusTrapManager, _inertStrategy, config) {
          ...
          _this30 = _super16.call(this, _element, _checker, _ngZone, _document, config.defer);
          _this30._focusTrapManager = _focusTrapManager;
          _this30._inertStrategy = _inertStrategy;

          _this30._focusTrapManager.register(_assertThisInitialized(_this30));
        ...
        _createClass(EventListenerFocusTrapInertStrategy, [{
          ...
          value: function preventFocus(focusTrap) {
            ...
            this._listener = function (e) {
              return _this31._trapFocus(focusTrap, e);
            };

            focusTrap._ngZone.runOutsideAngular(function () {
              focusTrap._document.addEventListener('focus', _this31._listener, true);
            });
          }
        ...
        _createClass(LiveAnnouncer, [{
          ...
          value: function announce(message) {
            ...
            return this._ngZone.runOutsideAngular(function () {
              return new Promise(function (resolve) {
                clearTimeout(_this32._previousTimeout);
                _this32._previousTimeout = setTimeout(function () {
                  _this32._liveElement.textContent = message;
                  resolve();

                  if (typeof duration === 'number') {
                    _this32._previousTimeout = setTimeout(function () {
                      return _this32.clear();
                    }, duration);
                  }
                }, 100);
              });
          ...
          set: function set(value) {
            ...
            if (this._politeness === 'off') {
              ...
              this._subscription = this._ngZone.runOutsideAngular(function () {
                return _this33._contentObserver.observe(_this33._elementRef).subscribe(function () {
                  // Note that we use textContent here, rather than innerText, in order to avoid a reflow.
                  var elementText = _this33._elementRef.nativeElement.textContent; // The `MutationObserver` fires also for attribute
                  // changes which we don't want to announce.

                  if (elementText !== _this33._previousAnnouncedText) {
                    _this33._liveAnnouncer.announce(elementText, _this33._politeness);

                    _this33._previousAnnouncedText = elementText;
                  }
                });
              });
            }
      ...
      var FocusMonitor = /*#__PURE__*/function () {
        ...
        document, options) {
          ...
          this._documentKeydownListener = function () {
            ...
            _this34._lastTouchTarget = null;

            _this34._setOriginForCurrentEventQueue('keyboard');
          };
          /**
          ...
          this._documentTouchstartListener = function (event) {
            ...
            if (!isFakeTouchstartFromScreenReader(event)) {
              ...
              if (_this34._touchTimeoutId != null) {
                clearTimeout(_this34._touchTimeoutId);
              }

              _this34._lastTouchTarget = getTarget(event);
              _this34._touchTimeoutId = setTimeout(function () {
                return _this34._lastTouchTarget = null;
              }, TOUCH_BUFFER_MS);
            } else if (!_this34._lastTouchTarget) {
              _this34._setOriginForCurrentEventQueue('keyboard');
            }
          };
          /**
          ...
          this._windowFocusListener = function () {
            ...
            _this34._windowFocused = true;
            _this34._windowFocusTimeoutId = setTimeout(function () {
              return _this34._windowFocused = false;
            });
          };
          /**
          ...
          this._rootNodeFocusAndBlurListener = function (event) {
            ...
            var handler = event.type === 'focus' ? _this34._onFocus : _this34._onBlur; // We need to walk up the ancestor chain in order to support `checkChildren`.

            for (var element = target; element; element = element.parentElement) {
              handler.call(_this34, event, element);
            }
          };
        ...
        _createClass(FocusMonitor, [{
          ...
          value: function focusVia(element, origin, options) {
            ...
            if (nativeElement === focusedElement) {
              this._getClosestElementsInfo(nativeElement).forEach(function (_ref2) {
                ...
                return _this35._originChanged(currentElement, origin, info);
              });
            } else {
          ...
          value: function ngOnDestroy() {
            ...
            this._elementInfo.forEach(function (_info, element) {
              return _this36.stopMonitoring(element);
            });
          }
          ...
          value: function _setOriginForCurrentEventQueue(origin) {
            ...
            this._ngZone.runOutsideAngular(function () {
              _this37._origin = origin;

              if (_this37._detectionMode === 0
              /* IMMEDIATE */
              ) {
                  // Sometimes the focus origin won't be valid in Firefox because Firefox seems to focus *one*
                  // tick after the interaction event fired. To ensure the focus origin is always correct,
                  // the focus origin will be determined at the beginning of the next tick.
                  _this37._originTimeoutId = setTimeout(function () {
                    return _this37._origin = null;
                  }, 1);
                }
            });
          }
          ...
          value: function _registerGlobalListeners(elementInfo) {
            ...
            if (!rootNodeFocusListeners) {
              this._ngZone.runOutsideAngular(function () {
                rootNode.addEventListener('focus', _this38._rootNodeFocusAndBlurListener, captureEventListenerOptions);
                rootNode.addEventListener('blur', _this38._rootNodeFocusAndBlurListener, captureEventListenerOptions);
              });
            }
            ...
            if (++this._monitoredElementCount === 1) {
              ...
              this._ngZone.runOutsideAngular(function () {
                var document = _this38._getDocument();

                var window = _this38._getWindow();

                document.addEventListener('keydown', _this38._documentKeydownListener, captureEventListenerOptions);
                document.addEventListener('mousedown', _this38._documentMousedownListener, captureEventListenerOptions);
                document.addEventListener('touchstart', _this38._documentTouchstartListener, captureEventListenerOptions);
                window.addEventListener('focus', _this38._windowFocusListener);
              });
            }
          }
        }, {
        ...
        _createClass(CdkMonitorFocus, [{
          ...
          value: function ngAfterViewInit() {
            ...
            this._monitorSubscription = this._focusMonitor.monitor(element, element.nodeType === 1 && element.hasAttribute('cdkMonitorSubtreeFocus')).subscribe(function (origin) {
              return _this39.cdkFocusChange.emit(origin);
            });
          }
        }, {
          key: "ngOnDestroy",
...
//# sourceMappingURL=default~gestion-actividades-actividades-module~gestion-convenios-convenios-module~gestion-enlaces-en~5eaaa385-es5.js.map