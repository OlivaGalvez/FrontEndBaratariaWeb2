(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["portal-ofertas-ofertas-module"], {
    ...
    /***/
    function zy2(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function gsD(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      OfertasComponent.ɵfac = function OfertasComponent_Factory(t) {
        return new (t || OfertasComponent)();
      };

      OfertasComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: OfertasComponent,
        selectors: [["app-ofertas"]],
        decls: 11,
        vars: 0,
        consts: [[1, "row", "justify-content-lg-center", "pb-4"], [1, "col-lg-4", "mb-4", "mb-lg-0", "mt-4"], ["href", "#", 1, "card", "card-sm", "card-transition-zoom"], [1, "card-transition-zoom-item"], ["src", "/assets/media/barataria/img3.jpg", "alt", "Image Description", 1, "card-img", "opacity"], [1, "card-img-overlay", "top-auto"], [1, "d-flex", "justify-content-end", "flex-column", "bg-white", "rounded-xl", "p-4", 2, "border", "3px solid #027762"], [1, "card-title", "text-dark", "mb-1"], [1, "text-dark", "mb-1"]],
        template: function OfertasComponent_Template(rf, ctx) {
          if (rf & 1) {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](OfertasComponent, [{
    ...
    /***/
    function HeLd(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _ofertas_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./ofertas.component */
      "7gsD");
      /* harmony import */


      var ngx_image_zoom__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ngx-image-zoom */
      "1zy2");
...
//# sourceMappingURL=portal-ofertas-ofertas-module-es5.js.map