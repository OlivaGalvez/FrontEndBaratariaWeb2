...
@Component({
  selector: 'app-documentacion-model',
  templateUrl: './documentacion-model.component.html',
  styleUrls: ['./documentacion-model.component.scss']
})
export class DocumentacionModelComponent implements OnInit {
