    ...
    function jTF(module, __webpack_exports__, __webpack_require__) {
      ...
      var UploadService = /*#__PURE__*/function () {
        function UploadService(http) {
          ...
          this.http = http;
          this.API_URL = "".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl) + 'api/File/';
        }

        _createClass(UploadService, [{
          key: "uploadImagen",
          value: function uploadImagen(file) {
          ...
          key: "uploadDocumento",
          value: function uploadDocumento(file) {
            var formData = new FormData();
            formData.append("file", file, file.name);
          ...
          value: function download(fileUrl) {
            return this.http.get(this.API_URL + 'Download?fileUrl=' + fileUrl, {
              responseType: 'blob'
            });
          }
        }, {
...
//# sourceMappingURL=default~gestion-actividades-actividades-module~gestion-convenios-convenios-module~gestion-enlaces-en~dc26ce70-es5.js.map